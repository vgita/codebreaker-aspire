...
namespace Codebreaker.Client.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Codebreaker.Client.Models.TimeSpanObject"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Codebreaker.Client.Models.TimeSpanObject CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Codebreaker.Client.Models.TimeSpanObject();
        }
        /// <summary>
